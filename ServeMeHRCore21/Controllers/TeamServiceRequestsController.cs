...
{
    public class TeamServiceRequestsController : Controller
    {
        private readonly ServeMeHRCoreContext _context;
        private IHostingEnvironment _environment;

        public TeamServiceRequestsController(ServeMeHRCoreContext context, IHostingEnvironment environment)
        {
            _context = context;
        ...
        public async Task<IActionResult> Index(string StatusType, string searchString)
        {
            ...
            serveMeHRCoreContext = from sr in _context.ServiceRequests
                              ...
                              join t in _context.Teams on sr.Team equals t.Id
                              join tm in _context.TeamMembers on t.Id equals tm.Team
                              join m in _context.Members on tm.Member equals m.Id
