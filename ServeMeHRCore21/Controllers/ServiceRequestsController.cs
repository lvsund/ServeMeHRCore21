...
namespace ServeMeHRCore21.Controllers
{
    public class ServiceRequestsController : Controller
    {
        ...
        public ServiceRequestsController(ServeMeHRCoreContext context, IWebHostEnvironment environment)
        {
            _context = context;
        ...
        public async Task<IActionResult> Index(string StatusType, string searchString)
        {
            ...
            var serveMeHRCoreContext = _context.ServiceRequests
    ...
    .SingleOrDefaultAsync(m => m.Id == id);
        ...
        public JsonResult DeleteFile(string id)
        {
            ...
            try
            {
                ...
                FileDetails fileDetail = _context.FileDetails.Find(guid);
                if (fileDetail == null)
                {
                ...
                //var path = Path.Combine(Server.MapPath("~/wwwroot/uploads/"), fileDetail.Id + fileDetail.Extension);
                var path = Path.Combine(
                           Directory.GetCurrentDirectory(),
                           "wwwroot\\uploads", fileDetail.FileName);
            ...
            foreach (var file in files)
                try
                {
                    ...
                    else
                    {
                        ...
                        _context.Update(serviceRequests.FileDetails);
                        //_context.Entry(serviceRequests.FileDetails).State = EntityState.Added;
                        await _context.SaveChangesAsync();
